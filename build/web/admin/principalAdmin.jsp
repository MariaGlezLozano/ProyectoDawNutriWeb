                        ...
                        <tbody>
                            <c:forEach var="dietista" items="${listaDietistas}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/admin/ControladorEditarDietistas?id=${dietista.idDietista}" class="btn btn-warning btn-sm">Editar</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                        ...
                        <tbody>
                            <c:forEach var="paciente" items="${listaPacientes}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="ControladorEditarPaciente?id=${paciente.idPaciente}" class="btn btn-warning btn-sm">Editar</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
