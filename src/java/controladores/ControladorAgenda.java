 ...
 * @author Maria
 */
@WebServlet(name = "ControladorAgenda", urlPatterns = {"/ControladorAgenda"})
public class ControladorAgenda extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //response.sendRedirect(request.getContextPath() + "/pacientes/agenda.jsp");
        request.getRequestDispatcher("/pacientes/agenda.jsp").forward(request, response);
