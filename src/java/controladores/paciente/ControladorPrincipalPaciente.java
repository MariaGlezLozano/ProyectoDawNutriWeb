/*
 * Controlador Principal Paciente
 */
 ...
 * @author Maria
 */
@WebServlet(name = "ControladorPrincipalPaciente", urlPatterns = {"/paciente/ControladorPrincipalPaciente"})
public class ControladorPrincipalPaciente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      //getServletContext().getRequestDispatcher("/pacientes/menuPaciente.jsp").forward(request, response);
        ...
        request.getRequestDispatcher("/pacientes/menuPaciente.jsp").forward(request, response);
    }
